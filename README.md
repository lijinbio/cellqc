...
mamba install r-seurat=4 r-seuratobject=4 r-matrix=1.6.1 # required by seurat-disk, Seurat v5 is not supported in SeuratDisk
Rscript -e "remotes::install_github(c('mojaveazure/seurat-disk', 'immunogenomics/harmony', 'powellgenomicslab/scPred'), upgrade=F)"
Rscript -e "remotes::install_github('lijinbio/DoubletFinder', upgrade=F, force=F)" # Bug fix @counts for Seurat object, instead of chris-mcginnis-ucsf/DoubletFinder
